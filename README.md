...
- **Access Token Expiry** → If access token expires, refresh token generates a new JWT automatically ♻️
- **Access Granted** → If token is valid, user gets access to protected routes and resources 🛡️
